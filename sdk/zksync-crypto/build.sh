...
# pack for browser
#wasm-pack build --release --target=web --out-name=zksync-crypto-web --out-dir=dist_web
# pack for node.js
#wasm-pack build --release --target=nodejs --out-name=zksync-crypto-node --out-dir=dist_nodejs
